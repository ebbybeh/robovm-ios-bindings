...
public interface GPGRealTimeRoomDelegate extends NSObjectProtocol {
	...
	void didRoomChangeStatus(GPGRealTimeRoom room, GPGRealTimeRoomStatus status);
	...
	void didParticipentChangeStatus(GPGRealTimeRoom room, GPGRealTimeParticipant participant, GPGRealTimeParticipantStatus status);
